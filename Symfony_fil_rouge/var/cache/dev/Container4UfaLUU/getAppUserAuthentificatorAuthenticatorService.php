 ...
 */
class getAppUserAuthentificatorAuthenticatorService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Security\AppUserAuthentificatorAuthenticator' shared autowired service.
     *
     * @return \App\Security\AppUserAuthentificatorAuthenticator
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Security'.\DIRECTORY_SEPARATOR.'AppUserAuthentificatorAuthenticator.php';

        return $container->privates['App\\Security\\AppUserAuthentificatorAuthenticator'] = new \App\Security\AppUserAuthentificatorAuthenticator(($container->services['router'] ?? $container->getRouterService()));
    }
}
