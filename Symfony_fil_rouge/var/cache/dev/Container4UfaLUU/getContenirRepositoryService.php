 ...
 */
class getContenirRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ContenirRepository.php';

        return $container->privates['App\\Repository\\ContenirRepository'] = new \App\Repository\ContenirRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
