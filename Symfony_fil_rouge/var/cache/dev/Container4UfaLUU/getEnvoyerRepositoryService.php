 ...
 */
class getEnvoyerRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EnvoyerRepository' shared autowired service.
     *
     * @return \App\Repository\EnvoyerRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EnvoyerRepository.php';

        return $container->privates['App\\Repository\\EnvoyerRepository'] = new \App\Repository\EnvoyerRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
