 ...
 */
class getCommercialRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CommercialRepository' shared autowired service.
     *
     * @return \App\Repository\CommercialRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CommercialRepository.php';

        return $container->privates['App\\Repository\\CommercialRepository'] = new \App\Repository\CommercialRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
