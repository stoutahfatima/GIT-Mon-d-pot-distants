 ...
 */
class getApprovisionnerRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ApprovisionnerRepository' shared autowired service.
     *
     * @return \App\Repository\ApprovisionnerRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ApprovisionnerRepository.php';

        return $container->privates['App\\Repository\\ApprovisionnerRepository'] = new \App\Repository\ApprovisionnerRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
